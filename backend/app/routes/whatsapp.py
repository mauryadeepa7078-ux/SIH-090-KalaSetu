...
async def twilio_whatsapp_webhook(
    ...
    bot_reply = (
        f"🙏 *नमस्ते! क्राफ्टएक्स (CraftX) AI बिज़नेस मैनेजर में आपका स्वागत है.*\n\n"
...
async def simulate_whatsapp_conversation(req: WhatsAppSimulationRequest):
        ...
        messages = [
            {
                "sender": "bot",
                "text": (
                    f"🙏 *नमस्ते! मैं आपका क्राफ्टएक्स (CraftX) AI बिज़नेस मैनेजर हूँ.*\n\n"
    ...
    messages = [
        ...
        {
            "sender": "bot",
            "text": f"✅ यह उत्पाद आपके क्राफ्टएक्स कैटलॉग में जुड़ गया है! आप इसे 1-क्लिक में GeM व ONDC पर भी लाइव कर सकते हैं। 🚀",
            "time": "Just now"
        }
    ]
