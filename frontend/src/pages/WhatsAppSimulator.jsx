    ...
    try {
      ...
      setMessages(prev => [
        ...prev,
        {
          id: Date.now(),
          sender: 'bot',
          text: '✅ आपका संदेश प्रोसेस हो गया है और क्राफ्टएक्स AI ने अपडेट दर्ज कर लिया है!',
          time: new Date().toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' })
        }
      ]);
    }
