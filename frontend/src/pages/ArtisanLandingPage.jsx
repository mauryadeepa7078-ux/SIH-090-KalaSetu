...
export const ArtisanLandingPage = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-6 sm:py-8 space-y-6 sm:space-y-8 animate-fade-in pb-28">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 bg-stone-900 border border-stone-800 rounded-3xl p-4 sm:p-6 shadow-xl relative overflow-hidden">
        <div className="flex items-center space-x-3.5 z-10">
          <div className="w-12 h-12 rounded-2xl bg-gradient-to-tr from-orange-600 to-amber-500 p-0.5 shadow-lg shadow-orange-900/40 flex items-center justify-center shrink-0">
          ...
          <div>
            <div className="flex items-center space-x-2">
              <h2 className="text-xl sm:text-2xl font-black text-white font-hindi">
                {lang === 'hi' ? 'नमस्ते, कारीगर साथी!' : 'Namaste, Artisan Partner!'}
              </h2>
              <span className="text-[10px] sm:text-xs px-2.5 py-0.5 rounded-full bg-orange-500/20 border border-orange-500/40 text-orange-400 font-bold">
                विक्रेता मोड
              </span>
            </div>
            <p className="text-xs sm:text-sm text-stone-400 mt-0.5">
              {lang === 'hi' 
                ? 'AI आपका पर्सनल बिजनेस मैनेजर है — सिर्फ 2 आसान कदमों में उत्पाद लाइव करें' 
        ...
        <div className="flex items-center space-x-2 self-start sm:self-auto z-10">
          <button
            ...
            className="px-3 py-1.5 rounded-xl bg-stone-800 hover:bg-stone-750 text-stone-300 border border-stone-700 text-xs font-semibold transition-all flex items-center space-x-1.5"
      ...
      <div className="p-5 sm:p-6 rounded-[28px] bg-gradient-to-r from-orange-950/70 via-stone-900 to-stone-900 border-2 border-orange-500/50 shadow-2xl relative overflow-hidden">
        <div className="flex items-start justify-between gap-4">
          <div className="flex items-start space-x-3.5">
            <div className="p-3 rounded-2xl bg-orange-600 text-white shadow-lg shadow-orange-900/50 shrink-0">
          ...
          <button
            ...
            className="p-3 rounded-2xl bg-stone-800 hover:bg-orange-600 text-stone-200 hover:text-white transition-all shadow-md shrink-0 flex items-center justify-center min-h-[44px] min-w-[44px]"
            title="Listen to AI guide voice"
          >
            <Volume2 className="w-5 h-5 text-orange-400 hover:text-white" />
          </button>
        </div>
      </div>
      ...
      <div className="space-y-3">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
          ...
          <button
            ...
            className="group relative p-6 sm:p-8 rounded-[32px] bg-gradient-to-br from-orange-600 via-amber-600 to-orange-500 text-white text-left shadow-2xl shadow-orange-900/30 hover:scale-[1.02] active:scale-[0.98] transition-all border border-orange-400/30 flex flex-col justify-between min-h-[220px]"
          >
            ...
            <div className="mt-6 space-y-1.5">
              <h3 className="text-2xl sm:text-3xl font-black tracking-tight font-hindi flex items-center justify-between">
          ...
          <button
            ...
            className="group relative p-6 sm:p-8 rounded-[32px] bg-gradient-to-br from-stone-800 via-stone-850 to-stone-900 text-white text-left shadow-2xl hover:scale-[1.02] active:scale-[0.98] transition-all border-2 border-stone-700 hover:border-orange-500 flex flex-col justify-between min-h-[220px]"
          >
            <div className="flex items-center justify-between w-full">
              <div className="p-4 rounded-2xl bg-orange-950/80 border border-orange-600/40 text-orange-400 group-hover:scale-110 transition-transform">
                <Mic className="w-8 h-8 sm:w-10 sm:h-10 animate-pulse" />
              </div>
              <span className="px-3 py-1 rounded-full bg-stone-700 text-stone-200 text-xs font-black tracking-wider uppercase">
                कदम 2 • Step 2
              </span>
            </div>

            <div className="mt-6 space-y-1.5">
              <h3 className="text-2xl sm:text-3xl font-black tracking-tight font-hindi flex items-center justify-between text-white group-hover:text-orange-400 transition-colors">
      ...
      <div className="space-y-4 pt-2">
        <div className="flex items-center justify-between px-1 border-t border-stone-800 pt-6">
          <div>
            <h4 className="text-base font-black text-white font-hindi">
              {t('quickTools')}
            </h4>
          ...
          {secondaryTools.map((tool) => {
            ...
            return (
              <button
                ...
                className="p-4 rounded-2xl bg-stone-850 hover:bg-stone-800 border border-stone-750 hover:border-orange-500/60 text-left transition-all group flex flex-col justify-between shadow-lg min-h-[110px]"
              >
                <div className="flex items-center justify-between">
                  <div className={`p-2.5 rounded-xl bg-gradient-to-tr ${tool.color} text-white shadow-md group-hover:scale-110 transition-transform`}>
                ...
                <div className="mt-3">
                  <span className="text-xs sm:text-sm font-extrabold text-white group-hover:text-orange-400 transition-colors block">
                    {tool.label}
                  </span>
                  <span className="text-[10px] text-stone-400 line-clamp-1 block mt-0.5">
                    {tool.desc}
                  </span>
                </div>
              </button>
